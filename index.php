...
<html>
<head>
<title>Get a love of your life - LoveFinder | Home ::
</title>
...
<div class="banner">
  <div class="container">
    <div class="banner_info">
      <h3>Thousands of Active Singles</h3>
...
<div class="grid_2">
	<div class="container">
			   ...
			   <li>
					...
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						   <img width="75" height="75" src="images/african%20couple.jpg" class="img-responsive" alt=""/>
					    </figure>
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Ben and Rophence</a></h4>
				        	<p>These two love birds met on this platform. Dated for only two months and got married.<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						   <img width="75" height="75" src="images/B.jpg" class="img-responsive" alt=""/>
					    </figure>
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Waititu and Njeri</a></h4>
				        	<p>The couple identified each other using our match-fixer.Since the first day, it has been more and more love<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						   <img width="75" height="75" src="images/C.jpg" class="img-responsive" alt=""/>
					    </figure>
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Salome and Amos</a></h4>
				        	<p>They say that love fears no security or high walls. A daughter of a minister with a former Kibera slum dweller<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						   <img width="75" height="75" src="images/D.jpg" class="img-responsive" alt=""/>
					    </figure>
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Rose and Frank</a></h4>
				        	<p>Love knows no education. This is the story of a Ph.D holder who married a high school dropout<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						   <img width="75" height="75" src="images/E.jpg" class="img-responsive" alt=""/>
					    </figure>
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Ann and Musyoka</a></h4>
				        	<p>Two people who had come for fun here, but ended up as a happy couple<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						   <img width="75" height="75" src="images/F.jpg" class="img-responsive" alt=""/>
					    </figure>
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Sandra and Kevin</a></h4>
				        	<p>A story of people from different continents who met and fell in love on our platform<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	            <li>
					...
					<div class="suceess_story-content-container">
						<figure class="suceess_story-content-featured-image">
						   <img width="75" height="75" src="images/G.jpg" class="img-responsive" alt=""/>
					    </figure>
						<div class="suceess_story-content-info">
				        	<h4><a href="#">Shake and David</a></h4>
				        	<p>The story of two divorcees who met ,fell in love on our platform<a href="#">More...</a></p>
				        </div>
				    </div>
				</li>
	        </ul>
	    ...
	    <div class="col-md-4 row_1-right">
	      <h3>News & Events</h3>
	        <div class="box_1">
		      <figure class="thumbnail1"><img width="170" height="155" src="images/U.jpg" class="img-responsive" alt=""/></figure>
			  <div class="extra-wrap">
				...
				<h4 class="post-title"><a href="#">Beach meet up</a></h4>
				<div class="clearfix"> </div>
				<div class="post-content">Happening at the Jomo Kenyatta public Beach</div>
				<a href="#" class="vertical">Read More</a>
			  </div>
	        </div>
	        <div class="box_1">
		      <figure class="thumbnail1"><img width="170" height="155" src="images/V.jpg" class="img-responsive" alt=""/></figure>
			  <div class="extra-wrap">
				<div class="post-meta">
					<span class="day">
					<time datetime="2014-05-25T10:15:43+00:00">25</time>
	        ...
	        <div class="box_2">
		      <figure class="thumbnail1"><img width="170" height="155" src="images/W.jpg" class="img-responsive" alt=""/></figure>
			  <div class="extra-wrap">
				<div class="post-meta">
					<span class="day">
					<time datetime="2014-05-25T10:15:43+00:00">25</time>
